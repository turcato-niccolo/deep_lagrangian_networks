"""
Script for training/testing of Deep Lagrangian Network of simulated data of a 2DOF pendulum
...
parser = argparse.ArgumentParser('Pendulum2DOF DeLaN estimator')
...
if flg_train:
    ...
    train_loss = delan_model.train_model(X_tr, Y_tr, optimizer, save_model=flg_save)
